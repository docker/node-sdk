...
test(
    'image lifecycle: create container, commit image, export/import, inspect, and prune',
    { timeout: 60000 },
    async () => {
        ...
        try {
            ...
            assert.notStrictEqual(commitResponse.Id, null);
            console.log(
            ...
            assert.notStrictEqual(
                testImage,
                null,
                'Test image should exist after commit',
            );
            console.log(
            ...
            assert.notStrictEqual(
                loadedImage,
                null,
                'Test image should exist after load',
            );
            ...
            if (containerId) {
                ...
                try {
                    ...
                    if ((err as NotFoundError)?.name === 'NotFoundError') {
                        console.log(
                            '    Container already deleted or not found',
                        );
                    } else {
                        console.log(
